...
affdex.getAffdexDotJsLocation = function () {
  ...
  var affdexJS = null; /// ~ The source must be hardcoded because the file is now self-hosted.

  var src = "https://download.affectiva.com/js/3.2/"; /// ~ No need for this loop
...
affdex.Detector = function () {
  ...
  var getActiveKeys = function getActiveKeys(dictionary) {
    var retArray = [];
  ...
  var setValueForAllKeys = function setValueForAllKeys(dictionary, value) {
    for (var key in dictionary) {
      dictionary[key] = value;
    }
  };

  var onWorkerReady = function onWorkerReady(status) {
    if (status) {
...
affdex.CameraDetector = function (element, imgW, imgH, faceMode) {
  ...
  self.onWebcamReady = function (stream) {
    ...
    var playingFn = function playingFn() {
      self.videoElement.removeEventListener("playing", self); //Call parent function
  ...
  var require = function require(rootDiv, file, success_callback, failure_callback) {
  ...
  var process = function process(img, timeStamp) {
    if (self.isWorkerInitialized) {
      self.worker.postMessage({
        "message": "process",
        "img": img,
...
/***/ 2:
/*!*********************************************!*\
  !*** multi ./resources/js/vendor/affdex.js ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\aanne\Documents\Emotionally\src\resources\js\vendor\affdex.js */"./resources/js/vendor/affdex.js");
