...
function () {
  ...
  _createClass(EmotionAnalysis, null, [{
    ...
    value: function analyzeVideo(filename) {
      ...
      detector.detectAllExpressions(); // Init variable to save results
      ...
      detector.start(); //Add a callback to notify when the detector is initialized and ready for runing.
      ...
      detector.addEventListener("onImageResultsSuccess", function (faces, image, timestamp) {
        ...
        if (faces.length > 0) {
          // Append timestamp
          faces[0].emotions[time_key] = time_val; // Save both emotions and expressions
...
window.EmotionAnalysis = EmotionAnalysis; // exports.default = EmotionAnalysis;
...
/***/ 1:
/*!************************************************!*\
  !*** multi ./resources/js/emotion-analysis.js ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! D:\GitProjects\Emotionally\src\resources\js\emotion-analysis.js */"./resources/js/emotion-analysis.js");
