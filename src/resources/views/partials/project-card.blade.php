<div class="col mb-4">
    <div class="project-detail-card card h-100 text-white square"
        ...
        <div class="card-img-overlay project-detail-card-options">
            @include('shared.dropdown-options-menu', ['id'=>'more-project-'.$project->id,'title'=>trans('project-details.more_options_project', ['name'=>$project->name]), 'item_id'=>$project->id,'named'=>'cacca'])
        </div>
    </div>
</div>
