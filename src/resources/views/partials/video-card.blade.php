<div class="col mb-4">
    <div class="project-detail-card card h-100 text-white square">
        ...
        <div class="card-img-overlay project-detail-card-options">
            @include('shared.dropdown-options-video', ['id'=>'more-video-'.$video->id,'title'=>trans('project-details.more_options_video', ['name'=>$video->name]), 'item_id'=>$video->id,'named'=>'cacca'])
        </div>
    </div>
</div>
