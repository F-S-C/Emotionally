    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control input-color" id="email" name="email" aria-describedby="email-icon" required>
            </div>
        </div>
        <div id="second">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="password" class="form-control input-color" id="password" name="password" aria-describedby="password-icon" autocomplete="on" required>
                </div>
            </div>
